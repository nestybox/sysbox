...
# accordingly.
@test "kind pod multi-container (weave)" {
...
@test "kind service clusterIP (weave)" {
...
@test "kind service nodePort (weave)" {
...
@test "kind deny all traffic (weave)" {
...
# a given namespace.
@test "kind limit app traffic (weave)" {
...
# policy.
@test "kind allow all traffic (weave)" {
...
# namespaces.
@test "kind deny traffic from other namespaces (weave)" {
...
@test "kind allow traffic from all namespaces (weave)" {
...
# properly enforced.
@test "kind allow traffic from some pods in other namespaces (weave)" {
...
@test "kind allow traffic to only one port app (weave)" {
...
@test "kind allow traffic using multiple selectors (weave)" {
