...
@test "rpm in inner redhat container (sysbox issue 130)" {
   ...
   docker exec "$syscont" sh -c "docker exec $inner_cont sh -c \"rpm -Uvh /var/cache/dnf/ubi-8-baseos-53c30a88cff3796c/packages/filesystem-3.8-3.el8.x86_64.rpm --force\""
   [ "$status" -eq 0 ]
